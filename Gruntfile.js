...
module.exports = function( grunt ) {
	...
	grunt.initConfig( {
		...
		makepot: {
			...
			go: {
				options: {
					potFilename: 'woocommerce-product-bundles-grid-columns.pot',
					exclude: [
						'languages/.*',
						'assets/.*',
						'node-modules/.*',
		...
		checktextdomain: {
			options:{
				text_domain: [ 'woocommerce-product-bundles-grid-columns' , 'woocommerce-product-bundles' ],
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
	...
	grunt.registerTask( 'deploy', function() {
		...
		// Sluggify title.
		title = 'woocommerce-product-bundles-grid-columns';
